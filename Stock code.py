...
dataset = pd.read_csv("E:/project/project/all_stocks_5yr.csv");
dataset.head()
dataset.info()
...
test_set = dataset.loc[dataset['Name'] == 'SIG'] 
# change CBS to whatever company from the list
test_set = test_set.loc[:, test_set.columns == 'close']
# storing the actual stock prices in y_test starting from 60th day as the previous 60 days are used 
#to predict the present day value.
